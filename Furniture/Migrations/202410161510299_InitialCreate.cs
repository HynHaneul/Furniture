    ...
    public partial class InitialCreate : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .ForeignKey("dbo._Product", t => t.C_Product_ID, cascadeDelete: true)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo._Product", "Product_Category_ID", "dbo.Product_Category");
            DropForeignKey("dbo.Order_Details", "C_Product_ID", "dbo._Product");
            ...
            DropIndex("dbo._Product", new[] { "Product_Category_ID" });
